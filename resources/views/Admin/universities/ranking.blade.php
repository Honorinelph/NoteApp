<!-- resources/views/admin/universities/ranking.blade.php -->
@extends('layouts.admin')

@section('content')
    <div class="flex justify-center items-center h-screen">
        <div class="max-w-4xl w-full px-4 py-8 bg-white shadow-md rounded-lg">
            <h1 class="text-3xl font-semibold text-center mb-8">Classements des universités</h1>

            <!-- Formulaire pour sélectionner les critères -->
            <form action="{{ route('admin.rankings') }}" method="GET" class="mb-8">
                @csrf
